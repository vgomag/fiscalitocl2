...
async function exportStatsCSV(){
  ...
  const headers=['Nombre','Resolución que instruye','Estado','Tipo Procedimiento','Materia','Protocolo','Resultado','Fecha Denuncia','Fecha Recepción','Fecha Vista','Denunciante(s)','Denunciado/a(s)','Est. Denunciante','Est. Denunciado','Carrera Dte.','Carrera Ddo.','Género'];
